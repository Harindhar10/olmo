...
Examples:
    ...
    python scripts/train_classification.py configs/classification.yaml

    # Custom config
    python scripts/train_classification.py my_config.yaml
"""
...
def main():
    config_path = sys.argv[1] if len(sys.argv) > 1 else "configs/classification.yaml"
