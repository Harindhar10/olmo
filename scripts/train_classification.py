...
def run_classification_experiment(args, task_name: str) -> None:
    """
    TODO: add type annotation for args
    Run training and evaluation on a MoleculeNet classification dataset.
    What it does:
        - Creates data loaders from .csv files containing the data (generated by prepare_data.py)
        - Instantiates model class (OLMoClassifier)
        - Instantiates callbacks for early stopping, checkpointing etc.
    ...
    args: 
        training arguments
    task: str
        name of the Moleculent dataset to run experiment on
    """
    # Get task config
