...
class OLMoRegression(nn.Module):
    def __init__(self, backbone):
        ...
        # MLP Head instead of simple Linear
    ...
    def forward(self, input_ids, attention_mask, labels=None):
        ...
        #preds = self.head(pooled_output).squeeze(-1)
...
def main():
    ...
    best_model_path = "/home/ubuntu/Harindhar/checkpoints_clearance/olmo-qlora-epoch=03-val/rmse=52.8911.ckpt" #checkpoint_callback.best_model_path
